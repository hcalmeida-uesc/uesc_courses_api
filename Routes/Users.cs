...
public static class Users
{
   public static void RegisterUsersEndpoints(this IEndpointRouteBuilder routes)
   {
      ...
      usersRoutes.MapPost("", async (IValidator<UserPostDTO> validator, UserPostDTO userPost, UescCourseAPIContext context) =>
      {
      ...
      usersRoutes.MapPut("/{id}", (int id, [FromBody] User user, UescCourseAPIContext context) =>
      {
